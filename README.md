# [go back to Main Content Index](https://github.com/c4arl0s/iOSProgramming_AdvancedObjectiveC#iosprogrammingadvace_objectivec)
...
4. [x] [4. Declarations](https://github.com/c4arl0s/1ASimpleiOSApplicationObjectiveCMRC#4-declarations)
5. [x] [5. Declaring Instance variables](https://github.com/c4arl0s/1ASimpleiOSApplicationObjectiveCMRC#5-declaring-instance-variables)
6. [x] [6. Declaring methods](https://github.com/c4arl0s/1ASimpleiOSApplicationObjectiveCMRC#6-declaring-methods)
7. [x] [7. Making connections](https://github.com/c4arl0s/1ASimpleiOSApplicationObjectiveCMRC#7-making-connections)
8. [x] [8. Setting Pointers](https://github.com/c4arl0s/1ASimpleiOSApplicationObjectiveCMRC#8-setting-pointers)
9. [x] [9. Setting targets and actions](https://github.com/c4arl0s/1ASimpleiOSApplicationObjectiveCMRC#9-setting-targets-and-actions)
10. [x] [10. Summary of connections](https://github.com/c4arl0s/1ASimpleiOSApplicationObjectiveCMRC#10-summary-of-connections)
11. [x] [11. Implementing methods](https://github.com/c4arl0s/1ASimpleiOSApplicationObjectiveCMRC#11-implementing-methods)
12. [x] [12. Build and Run on the Simulator](https://github.com/c4arl0s/1ASimpleiOSApplicationObjectiveCMRC#12-build-and-run-on-the-simulator)
13. [x] [13. Deploying an Application](https://github.com/c4arl0s/1ASimpleiOSApplicationObjectiveCMRC#13-deploying-an-application)
14. [x] [14. Application icons](https://github.com/c4arl0s/1ASimpleiOSApplicationObjectiveCMRC#14-application-icons)
...
4. [x] [4. Reference Counting](https://github.com/c4arl0s/3MemoryManagement#4-reference-counting)
5. [x] [5. Using retain counts](https://github.com/c4arl0s/3MemoryManagement#5-using-retain-counts)
6. [x] [6. Using autorelease](https://github.com/c4arl0s/3MemoryManagement#6-using-autorelease)
7. [x] [7. Accessors and Memory Management](https://github.com/c4arl0s/3MemoryManagement#7-accessor-and-memory-management)
8. [x] [8. Implementing dealloc](https://github.com/c4arl0s/3MemoryManagement#8-implementing-dealloc)
9. [x] [9. Simplifying accessors with Properties](https://github.com/c4arl0s/3MemoryManagement#9-simplifying-accessors-with-properties)
10. [x] [10. copy and mutablecopy](https://github.com/c4arl0s/3MemoryManagement#10-copy-and-mutablecopy)
11. [x] [11. Retain count rules](https://github.com/c4arl0s/3MemoryManagement#11-retain-count-rules)
12. [x] [12. For the More Curious: More on Memory Management](https://github.com/c4arl0s/3MemoryManagement#12-for-the-more-curious-more-on-memory-management) 
    * [x] [The data segment](https://github.com/c4arl0s/3MemoryManagement#-the-data-segment)
    * [x] [The stack](https://github.com/c4arl0s/3MemoryManagement#-the-stack)
...
3. [x] [3. Receiving updates from CLLocationManager](https://github.com/c4arl0s/4DelegationAndCoreLocation#3-receiving-updates-from-cllocationmanager)
   * [x] [Important: use locationManager requestWhenInUseAuthorization method](https://github.com/c4arl0s/4DelegationAndCoreLocation#4-delegation)
   * [x] [Important: edit info.plist, Privacy - Location When In Use Usage Description](https://github.com/c4arl0s/4DelegationAndCoreLocation#3-receiving-updates-from-cllocationmanager)
4. [x] [4. Delegation](https://github.com/c4arl0s/4DelegationAndCoreLocation#4-delegation)
5. [x] [5. Protocols](https://github.com/c4arl0s/4DelegationAndCoreLocation#5-protocols)
6. [x] [6. Protocol Methods](https://github.com/c4arl0s/4DelegationAndCoreLocation#6-protocol-methods)
    - [x] [Stop Using UISceneDelegate/SwiftUI in Xcode 11.5](https://github.com/c4arl0s/4DelegationAndCoreLocation#--stop-using-uiscenedelegateswiftui-in-xcode-115)
7. [x] [7. Delegation, controllers and Memory Management](https://github.com/c4arl0s/4DelegationAndCoreLocation#7-delegation-controllers-and-memory-management)
8. [x] [8. Using the Debugger](https://github.com/c4arl0s/4DelegationAndCoreLocation#8-using-the-debugger)
9. [x] [9. Challenge: Heading](https://github.com/c4arl0s/4DelegationAndCoreLocation#9-challenge-heading)
...
3. [x] [3. MapKit Framework](https://github.com/c4arl0s/5MapKitAndTextInput#3-mapkit-framework)
4. [x] [4. Interface Properties](https://github.com/c4arl0s/5MapKitAndTextInput#4-interface-properties)
5. [x] [5. Being a MapView Delegate](https://github.com/c4arl0s/5MapKitAndTextInput#5-being-a-mapview-delegate)
6. [x] [6. Using The Documentation](https://github.com/c4arl0s/5MapKitAndTextInput#6-using-the-documentation)
7. [x] [7. Your own MKAnnotation](https://github.com/c4arl0s/5MapKitAndTextInput#7-your-own-mkannotation)
8. [x] [8. Tagging locations](https://github.com/c4arl0s/5MapKitAndTextInput#8-tagging-locations)
9. [x] [9. Putting the pieces together](https://github.com/c4arl0s/5MapKitAndTextInput#9-putting-the-pieces-together)
10. [x] [10. Challenge: Annotation Extras](https://github.com/c4arl0s/5MapKitAndTextInput#10-challenge-annotation-extras)
11. [x] [11. Challenge: Reverse Geocoding](https://github.com/c4arl0s/5MapKitAndTextInput#11-challenge-reverse-geocoding)
...
3. [x] [3. UIDevice Notifications](https://github.com/c4arl0s/9NotificationAndRotation#3-uidevice-notifications)
4. [x] [4. Autorotation](https://github.com/c4arl0s/9NotificationAndRotation#4-autorotation)
5. [x] [5. Setting autoresizing masks programmatically and bitwise operations](https://github.com/c4arl0s/9NotificationAndRotation#5-setting-autoresizing-masks-programmatically-and-bitwise-operations)
6. [x] [6. Forcing Lanndscape Mode](https://github.com/c4arl0s/9NotificationAndRotation#6-forcing-lanndscape-mode)
7. [x] [7. Challenge: Proximity Notifications](https://github.com/c4arl0s/9NotificationAndRotation#7-challenge-proximity-notifications)
...
3. [x] [3. subclassing UITableViewController](https://github.com/c4arl0s/10UITableViewAndUITableViewController_ObjectiveC#3-subclassing-uitableviewcontroller)
4. [x] [4. UITableView's Data Source](https://github.com/c4arl0s/10UITableViewAndUITableViewController_ObjectiveC#4-uitableviews-data-source)
5. [x] [5. PossessionStore: a singleton](https://github.com/c4arl0s/10UITableViewAndUITableViewController_ObjectiveC#5-possessionstore-a-singleton)
6. [x] [6. Implementing data source methods](https://github.com/c4arl0s/10UITableViewAndUITableViewController_ObjectiveC#6-implementing-data-source-methods)
7. [x] [7. UItableViewCells](https://github.com/c4arl0s/10UITableViewAndUITableViewController_ObjectiveC#7-uitableviewcells)
8. [x] [8. Creating and retrieving UITableViewCells](https://github.com/c4arl0s/10UITableViewAndUITableViewController_ObjectiveC#8-creating-and-retrieving-uitableviewcells)
9. [x] [9. Reusing UITableViewCells](https://github.com/c4arl0s/10UITableViewAndUITableViewController_ObjectiveC#9-reusing-uitableviewcells)
10. [x] [10. Code Snippet Library](https://github.com/c4arl0s/10UITableViewAndUITableViewController_ObjectiveC#10-code-snippet-library)
11. [x] [11. Challenge: Sections](https://github.com/c4arl0s/10UITableViewAndUITableViewController_ObjectiveC#11-challenge-sections) 
...
3. [x] [3. An Additional UIViewController](https://github.com/c4arl0s/12UINavigationController#3-an-additional-uiviewcontroller)
4. [x] [4. Navigating with UINavigationController](https://github.com/c4arl0s/12UINavigationController#4-navigating-with-uinavigationcontroller)
5. [x] [5. Pushing view controllers](https://github.com/c4arl0s/12UINavigationController#5-pushing-view-controllers)
6. [x] [6. Passing data between view controllers](https://github.com/c4arl0s/12UINavigationController#6-passing-data-between-view-controllers)
7. [x] [7. Appearing and disappearing views](https://github.com/c4arl0s/12UINavigationController#7-appearing-and-disappearing-views)
...
3. [x] [3. ImageStore](https://github.com/c4arl0s/13Camera_ObjectiveC_NoARC#3-imagestore)
4. [x] [4. NSDictionary](https://github.com/c4arl0s/13Camera_ObjectiveC_NoARC#4-nsdictionary)
5. [x] [5. Creating and using keys](https://github.com/c4arl0s/13Camera_ObjectiveC_NoARC#5-creating-and-using-keys)
6. [x] [6. Dismissing the keyboard](https://github.com/c4arl0s/13Camera_ObjectiveC_NoARC#6-dismissing-the-keyboard)
7. [x] [7. Challenge: Removing an Image](https://github.com/c4arl0s/13Camera_ObjectiveC_NoARC#7-challenge-removing-an-image)
8. [x] [8. For the More Curious: Recording Video](https://github.com/c4arl0s/13Camera_ObjectiveC_NoARC#8-for-the-more-curious-recording-video)

# [14. UIPopoverController And ModalViewControllers (using MRC)](https://github.com/c4arl0s/14UIPopoverControllerAndModalViewControllers#14-uipopovercontroller-and-modalviewcontrollers)
...
4. [x] [4. Dismissing Modal View Controllers](https://github.com/c4arl0s/14UIPopoverControllerAndModalViewControllers#4-dismissing-modal-view-controllers)
5. [x] [5. Modal View Controllers Styles](https://github.com/c4arl0s/14UIPopoverControllerAndModalViewControllers#5-modal-view-controllers-styles)
6. [x] [6. Writing a View Controller Delegate Protocol](https://github.com/c4arl0s/14UIPopoverControllerAndModalViewControllers#6-writing-a-view-controller-delegate-protocol)
...
3. [x] [3. Archiving](https://github.com/c4arl0s/15SavingLoadingAndMultitaskingObjectiveCNoARC#3-archiving)
4. [x] [4. Archiving objects](https://github.com/c4arl0s/15SavingLoadingAndMultitaskingObjectiveCNoARC#4-archiving-objects)
5. [x] [5. Unarchiving objects](https://github.com/c4arl0s/15SavingLoadingAndMultitaskingObjectiveCNoARC#5-unarchiving-objects)
6. [x] [6. Application States, Transitions, and multitasking](https://github.com/c4arl0s/15SavingLoadingAndMultitaskingObjectiveCNoARC#6-application-states-transitions-and-multitasking)
7. [x] [7. writing to filesystems with NSData](https://github.com/c4arl0s/15SavingLoadingAndMultitaskingObjectiveCNoARC#7-writing-to-filesystems-with-nsdata)
8. [x] [8. More on Low-Memory Warnings](https://github.com/c4arl0s/15SavingLoadingAndMultitaskingObjectiveCNoARC#8-more-on-low-memory-warnings)
9. [x] [9. Model-View-Controller-Store Design Pattern](https://github.com/c4arl0s/15SavingLoadingAndMultitaskingObjectiveCNoARC#9-model-view-controller-store-design-pattern)
10. [x] [10. Challenge: Archiving Whereami](https://github.com/c4arl0s/15SavingLoadingAndMultitaskingObjectiveCNoARC#10-challenge-archiving-whereami)
11. [x] [11. For the more Curious: Application State Transitions](https://github.com/c4arl0s/15SavingLoadingAndMultitaskingObjectiveCNoARC#11-for-the-more-curious-application-state-transitions)
12. [x] [12. For the more Curious: Reading and Writing to the filesystem](https://github.com/c4arl0s/15SavingLoadingAndMultitaskingObjectiveCNoARC#12-for-the-more-curious-reading-and-writing-to-the-filesystem)
13. [x] [13. For the more Curious: The Application Bundle](https://github.com/c4arl0s/15SavingLoadingAndMultitaskingObjectiveCNoARC#13-for-the-more-curious-the-application-bundle)
...
4. [x] [4. Using the custom cell](https://github.com/c4arl0s/16SubclassingUITableViewCellObjectiveC_NoARC#4-using-the-custom-cell)
5. [x] [5. Image Manipulation](https://github.com/c4arl0s/16SubclassingUITableViewCellObjectiveC_NoARC#5-image-manipulation)
6. [x] [6. Challenge: Accessory Indicators](https://github.com/c4arl0s/16SubclassingUITableViewCellObjectiveC_NoARC#6-challenge-accessory-indicators)
...
3. [x] [3. The model file](https://github.com/c4arl0s/17CoreData_ObjectiveC_NoARC#3-the-model-file)
4. [x] [4. NSManagedObject and subclasses](https://github.com/c4arl0s/17CoreData_ObjectiveC_NoARC#4-nsmanagedobject-and-subclasses)
5. [x] [5. Updating PossessionStore](https://github.com/c4arl0s/17CoreData_ObjectiveC_NoARC#5-updating-possessionstore)
6. [x] [6. Adding AssetTypes to Homepwner](https://github.com/c4arl0s/17CoreData_ObjectiveC_NoARC#6-adding-assettypes-to-homepwner)
7. [x] [7. More about SQL](https://github.com/c4arl0s/17CoreData_ObjectiveC_NoARC#7-more-about-sql)
8. [x] [8. Trade-offs of Persistence Mechanisms](https://github.com/c4arl0s/17CoreData_ObjectiveC_NoARC#8-trade-offs-of-persistence-mechanisms)
9. [x] [9. Challenge: New Asset Types](https://github.com/c4arl0s/17CoreData_ObjectiveC_NoARC#9-challenge-new-asset-types)
10. [x] [10. Challenge: Assets on the iPad](https://github.com/c4arl0s/17CoreData_ObjectiveC_NoARC#10-challenge-assets-on-the-ipad)
...
4. [x] [4. Challenge: Another localization](https://github.com/c4arl0s/18LocalizationObjectiveCMRC#4-challenge-another-localization)
...
4. [x] [Working with NSURLConnection](https://github.com/c4arl0s/25WebServicesAndUIWebViewObjectiveCMRC#4-working-with-nsurlconnection)
5. [x] [Parsing XML](https://github.com/c4arl0s/25WebServicesAndUIWebViewObjectiveCMRC#5-parsing-xml)
6. [x] [A quick tip on logging](https://github.com/c4arl0s/25WebServicesAndUIWebViewObjectiveCMRC#6-a-quick-tip-on-logging)
7. [x] [UIWebView](https://github.com/c4arl0s/25WebServicesAndUIWebViewObjectiveCMRC#7-uiwebview)
8. [x] [For the More Curious: NSXMLParser](https://github.com/c4arl0s/25WebServicesAndUIWebViewObjectiveCMRC#8-for-the-more-curious-nsxmlparser)
9. [x] [For the More Curious: The Request Body](https://github.com/c4arl0s/25WebServicesAndUIWebViewObjectiveCMRC#9-for-the-more-curious-the-request-body)
10. [x] [For the More Curious: Credentials](https://github.com/c4arl0s/25WebServicesAndUIWebViewObjectiveCMRC#10-for-the-more-curious-credentials)
11. [x] [Challenge: More Data](https://github.com/c4arl0s/25WebServicesAndUIWebViewObjectiveCMRC#11-challenge-more-data)
...
3. [x] [3. Displaying the Master View Controller in Portrait Mode](https://github.com/c4arl0s/26UISplitViewControllerObjectriveCMRC#3-displaying-the-master-view-controller-in-portrait-mode)
4. [x] [4. Universalizing Nerdfeed](https://github.com/c4arl0s/26UISplitViewControllerObjectriveCMRC#4-universalizing-nerdfeed)
